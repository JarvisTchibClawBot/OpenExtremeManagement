    ...
    <div className="min-h-screen bg-gray-900 flex">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 lg:ml-0">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-gray-400 mt-1 text-sm sm:text-base">Network overview and statistics</p>
        </div>
              ...
              {statCards.map((card, index) => (
                <div key={index} className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gradient-to-br ${card.color} flex items-center justify-center text-white`}>
                      {card.icon}
                    </div>
                  </div>
                </div>
